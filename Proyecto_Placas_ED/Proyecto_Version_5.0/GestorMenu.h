...
class GestorMenu {
    ...
    public:
        ...
        void ejecutarBusquedaBinariaTemplates(){
            ...
            // Requisito indispensable de la búsqueda binaria: Ordenar previamente la lista bajo el criterio a buscar
        ...
        void ejecutarAgendamiento() {
            ...
            while(true){
                ...
                if(mm<0||mm>59){
                    cout<<"[RECHAZADO] Los minutos deben estar entre 0 and 59.\n"<<endl;
                    continue;
                }
