...
int main(){
	...
	cout<<"Comparando Quebrado 1 con Quebrado 2: "<<quebrado1.dec();
	if(quebrado1>quebrado2){
		cout<<"El quebrado 1 es MAYOR que el quebrado 2"<<endl;
	}else{
		cout<<"El quebrado 2 es MAYOR que el quebrado 1"<<endl;
	}
	return 0;
}
